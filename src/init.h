...
const static uint8_t SERVICE_EDUCATION[] = {
    0xbd, 0xcc, 0xd3, 0xfd, 0xcd, 0xf8, 0xbd, 0xd3, 0xc8, 0xeb};  //教育网接入
const static uint8_t SERVICE_CHINA_UNICOM[] = {0xc1, 0xaa, 0xcd, 0xa8, 0xbf,
                                               0xed, 0xb4, 0xf8, 0xbd, 0xd3,
                                               0xc8, 0xeb};  // 联通宽带接入
const static uint8_t SERVICE_CHINA_MOBILE[] = {0xd2, 0xc6, 0xb6, 0xaf, 0xbf,
                                               0xed, 0xb4, 0xf8, 0xbd, 0xd3,
                                               0xc8, 0xeb};  // 移动宽带接入
const static uint8_t SERVICE_CHINA_TELECOM[] = {0xb5, 0xe7, 0xd0, 0xc5, 0xbf,
                                                0xed, 0xb4, 0xf8, 0xbd, 0xd3,
                                                0xc8, 0xeb};  // 电信宽带接入
