...
#define PACK_32_BE(str, x)                                                   \
  {                                                                          \
    *(x) = ((uint32_t) * ((str)) << 24) ^ ((uint32_t) * ((str) + 1) << 16) ^ \
...
#define PACK_32_LE(str, x)                                            \
  {                                                                   \
    *(x) = ((uint32_t) * ((str))) ^ ((uint32_t) * ((str) + 1) << 8) ^ \
           ((uint32_t) * ((str) + 2) << 16) ^                         \
           ((uint32_t) * ((str) + 3) << 24);                          \
  }
...
#define PACK_64_LE(str, x)                                                    \
  {                                                                           \
    *(x) =                                                                    \
        ((uint64_t) * ((str))) ^ ((uint64_t) * ((str) + 1) << 8) ^            \
        ((uint64_t) * ((str) + 2) << 16) ^ ((uint64_t) * ((str) + 3) << 24) ^ \
        ((uint64_t) * ((str) + 4) << 32) ^ ((uint64_t) * ((str) + 5) << 40) ^ \
        ((uint64_t) * ((str) + 6) << 48) ^ ((uint64_t) * ((str) + 7) << 56);  \
  }
#endif
