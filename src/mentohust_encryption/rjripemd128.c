...
void ampheck_ripemd128_transform(struct ampheck_ripemd128 *ctx,
  ...
  for (i = 0; i < blocks; ++i) {
    ...
    wv[1] = ROL(wv[1] + ((wv[2] & (wv[3] ^ wv[0])) ^ wv[0]) + w[3] - 0x43234e07,
                15);
    ...
    wv[2] = ROL(
        wv[2] + ((wv[3] & wv[1]) | (wv[0] & ~wv[1])) + w[11] + 0x325b99a1, 14);
    ...
    wv[3] = ROL(
        wv[3] + ((wv[0] & wv[2]) | (wv[1] & ~wv[2])) + w[3] + 0x1baed69c, 14);
    ...
    wv[1] = ROL(
        wv[1] + ((wv[2] & wv[0]) | (wv[3] & ~wv[0])) + w[2] - 0x43234e04, 12);
    ...
    wv[6] = ROL(
        wv[6] + ((wv[7] & wv[5]) | (wv[4] & ~wv[5])) + w[3] - 0x43234e04, 12);
    ...
    wv[6] = ROL(
        wv[6] + ((wv[7] & wv[4]) | (~wv[7] & wv[5])) + w[4] + 0x41d42d5d, 7);
